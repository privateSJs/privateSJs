...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            <h1 className="text-4xl font-bold mb-6">Privacy Policy for Perpetuum Mobile</h1>
            <p className="text-lg mb-4">Last updated: February 04, 2025</p>
            ...
            <ul className="list-inside list-disc">
                ...
                <li>
                    <strong>Company:</strong> refers to Perpetuum Mobile.
                </li>
                <li>
                ...
                <li>
                    <strong>Website:</strong> refers to Perpetuum Mobile, accessible from{' '}
                    <a href="https://privatesjs.github.io/privateSJs/" className="text-blue-500">
                        https://privatesjs.github.io/privateSJs/
                    </a>
                </li>
                <li>
            ...
            <p>
                ...
                Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">Information from Third-Party Social Media Services</h2>
            ...
            <ul>
                <li>By email: jarek9917@gmail.com</li>
            </ul>
        </div>
    );
};
