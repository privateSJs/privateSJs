...
const AboutMe = () => {
  ...
  return (
      ...
      <motion.div
          className="relative ml-[20px] mt-5 mr-[20px] lg:ml-[100px] lg:mr-[100px] justify-center items-center bg-white shadow-[30px_30px_30px_rgba(255,255,255,0.2)] border-black border-opacity-20 text-black font-bold opacity-95 max-w-fit max-h-fit"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          ...
          <div
              ...
              <div className="relative flex flex-col py-2 px-5 w-full text-justify items-center justify-center">
                  <div className="relative flex w-[200px] h-[300px] md:w-[600px] md:h-[400px] lg:w-[800px] lg:h-[600px]">
                      {imgs.map((img, i) => (
                          <Image key={i} src={img}
                                 alt={`Slideshow Image ${i}`}
                                 className={`absolute max-w-[200px] md:max-w-[600px] md:h-[400px] h-[300px] lg:max-w-[800px] lg:h-[600px] mb-4 transform object-cover duration-1000 ease-in-out transition-opacity rounded-xl ${
