...
const CustomSidebar = ({
  ...
  socialItems,
  imgSrc,
  classNameSidebar = "flex gap-10 min-w-full w-full flex-row bg-[#000000] items-center justify-center text-xl text-white p-6 border-b-2 border-white border-opacity-20 mb-2",
  ...
  classNameImage = "flex justify-center h-[75px] w-[100px] lg:h-[150px] lg:w-[200px] object-cover rounded-full",
